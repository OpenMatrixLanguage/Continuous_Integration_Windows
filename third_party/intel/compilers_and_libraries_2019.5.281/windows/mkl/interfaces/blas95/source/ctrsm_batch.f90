...
PURE SUBROUTINE CTRSM_BATCH_F95(A_ARRAY,B_ARRAY,M_ARRAY,N_ARRAY,    &
     &                          GROUP_SIZE,SIDE_ARRAY,UPLO_ARRAY,   &
     &                          TRANSA_ARRAY,DIAG_ARRAY,ALPHA_ARRAY)
    ! Fortran77 call:
    ! CTRSM_BATCH(SIDE_ARRAY,UPLO_ARRAY,TRANSA_ARRAY,DIAG_ARRAY,M_ARRAY,N_ARRAY,
    ...
    ! <<< Local declarations >>>
    ! <<< Parameters >>>
    CHARACTER(LEN=11), PARAMETER :: SRNAME = 'CTRSM_BATCH'
    ! <<< Local scalars >>>
    ...
    ENDIF
END SUBROUTINE CTRSM_BATCH_F95
