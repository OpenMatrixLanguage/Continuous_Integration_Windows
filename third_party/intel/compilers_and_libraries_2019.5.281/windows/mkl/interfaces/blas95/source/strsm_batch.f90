...
PURE SUBROUTINE STRSM_BATCH_F95(A_ARRAY,B_ARRAY,M_ARRAY,N_ARRAY,    &
     &                          GROUP_SIZE,SIDE_ARRAY,UPLO_ARRAY,   &
     &                          TRANSA_ARRAY,DIAG_ARRAY,ALPHA_ARRAY)
    ! Fortran77 call:
    ! STRSM_BATCH(SIDE_ARRAY,UPLO_ARRAY,TRANSA_ARRAY,DIAG_ARRAY,M_ARRAY,N_ARRAY,
    ...
    ! <<< Local declarations >>>
    ! <<< Parameters >>>
    CHARACTER(LEN=11), PARAMETER :: SRNAME = 'STRSM_BATCH'
    ! <<< Local scalars >>>
    ...
    ENDIF
END SUBROUTINE STRSM_BATCH_F95
