...
#  pragma once
   ...
   // [08/08/2019 - SDG] - Short term fix to prevent ATI failures
   // Need to add cleanup code to sigaction handlers and use a better random number generating for the names.
